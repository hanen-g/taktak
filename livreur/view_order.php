            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/bookingSystem/livreur-icn.jpeg" alt="user" class="profile-pic" /></a>
            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="dashboard_livreur.php"><i class="fa fa-tachometer"></i><span>Dashboard</span></a></li>
                        
                        <li class="nav-label">Delivery Management</li>
                        
                        <li> <a href="all_orders.php"><i class="fa fa-list-alt"></i><span>Orders Tracking</span></a></li>
											...
											$sql="SELECT users.*, users_orders.* FROM users INNER JOIN users_orders ON users.u_id=users_orders.u_id where o_id='".$_GET['user_upd']."'";
												...
												?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <center><?php echo $rows['price']; ?>DT</center>
                                                                </td>
