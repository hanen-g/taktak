...
<body>
    ...
    <?php if ($status == 'closed'): ?>
        <div class="rating" data-order-id="<?= $row['o_id'] ?>">
            <?php for ($i = 1; $i <= 5; $i++): ?>
                <span class="fa fa-star-o star" data-rating="<?= $i ?>"></span>
            <?php endfor; ?>
        </div>
    <?php else: ?>
        <a href="delete_orders.php?order_del=<?= $row['o_id'] ?>" onclick="return confirm('Are you sure you want to cancel your order?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10">
...
$(document).ready(function () {
    $(".star").on("click", function () {
        ...
        var orderId = $star.closest(".rating").data("order-id");
