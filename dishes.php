...
?>
                                ...
                                <div class="form-group row no-gutter">
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control b-r-0" value=<?php echo "DT".$item["price"]; ?> readonly id="exampleSelect1">
...
?>
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                <p>TOTAL</p>
                                <h3 class="value"><strong><?php echo "DT".$item_total; ?></strong></h3>
                                <p>Free Delivery!</p>
                                <?php
                                        if($item_total==0){
                                        ?>
                            ...
                            <div class="food-item">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-lg-3 pull-right item-cart-info">
                                        <span class="price pull-left">DT<?php echo $product['price']; ?></span>
